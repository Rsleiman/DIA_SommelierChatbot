...
food_pairing_system_prompt_generator = SystemPromptGenerator(
        background= [
        ...
        "The customer chose a certain wine, and you should suggest a food that pairs well with it from the options below.",
    ],
    steps= [
...
food_pairing_agent = BaseAgent(
    config=BaseAgentConfig(
        client=instructor.from_openai(llm),
        model="gpt-4o-mini",
        system_prompt_generator=food_pairing_system_prompt_generator,
